  ...
  <div class="col-md-8 offset-md-2">
    ...
    <div class="card mt-3">
      <div class="card-body">
        ...
        <form action="{{ route('admin.roles.update', $role->slug) }}" method="POST">
          @csrf
          @method('PUT')
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" name="permissions[]" value="{{ $permission->id }}" id="perm_{{ $permission->id }}" {{ (is_array($oldPermissions) && in_array($permission->id, $oldPermissions)) ? 'checked' : '' }}>
