...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description" content="About {{ config('company.name') }}">
        ...
        <link rel="stylesheet" href="{{ asset('buzbox/css/about.css') }}">
    </head>
    ...
    <body id="page-top">
        ...
        <div id="home-p" class="home-p pages-head1 text-center">
            <div class="container">
                <h1 class="wow fadeInUp" data-wow-delay="0.1s">{{ config('company.name') }} — Building digital solutions that grow businesses</h1>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="about-p1-cont">
                            ...
                            <p>{{ config('company.name') }} is a results-driven business technology company focused on helping organizations transform, grow, and innovate. Our team combines strategic insight with practical execution to deliver digital products, services, and experiences that create measurable value.</p>
                    ...
                    <div class="col-md-4">
                        <div class="about-p1-img">
                            <img src="{{ asset('buzbox/img/ipad-tablet.png') }}" class="img-fluid wow fadeInUp" data-wow-delay="0.1s" alt="{{ config('company.name') }}">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-12">
                        <div class="about-p2-cont cl-white">
                            <img src="{{ asset('buzbox/img/news/news-5.jpg') }}" class="img-fluid wow fadeInUp" data-wow-delay="0.1s" alt="">
                        </div>
                    </div>
                    <div class="col-md-4">
        ...
        <section id="story" class="about-p3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="story-himg">
                            <img src="{{ asset('buzbox/img/img/image-3.jpg') }}" class="img-fluid wow fadeInUp" data-wow-delay="0.1s" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6 ">
                        <div class="story-himg story-himg-middle-u">
                            <img src="{{ asset('buzbox/img/img/image-2.jpg') }}" class="img-fluid wow fadeInUp" data-wow-delay="0.1s" alt="">
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6 ">
                        <div class="story-himg story-himg-middle-l">
                            <img src="{{ asset('buzbox/img/img/image-2.jpg') }}" class="img-fluid" alt="">
                        </div>
                    </div>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="story-himg">
                            <img src="{{ asset('buzbox/img/img/image-1.jpg') }}" class="img-fluid wow fadeInUp" data-wow-delay="0.1s" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script src="{{ asset('buzbox/js/bootstrap/bootstrap.bundle.min.js') }}"></script>
        <script src="{{ asset('buzbox/js/main.js') }}"></script>
