                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="category" id="category-<?php echo e($cat); ?>"
                                       value="<?php echo e($cat); ?>" <?php echo e(request('category') === $cat ? 'checked' : ''); ?>>
                                <label class="form-check-label" for="category-<?php echo e($cat); ?>" style="cursor: pointer;">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cat === 'web'): ?>
                                        <i class="fas fa-globe" style="color: #667eea;"></i> Web Apps
                                    <?php elseif($cat === 'mobile'): ?>
                            ...
                            <div class="card h-100 shadow-sm" style="border: 1px solid #e9ecef; border-radius: 12px; overflow: hidden; transition: all 0.3s ease;">
                                ...
                                <div style="height: 220px; background: linear-gradient(135deg, #f5f7fa 0%, #e9ecef 100%); overflow: hidden; position: relative;">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($portfolio->thumbnail): ?>
                                        <a href="<?php echo e(route('shop.show', $portfolio)); ?>" class="text-decoration-none">
                                            <img src="<?php echo e(asset('storage/' . $portfolio->thumbnail)); ?>" alt="<?php echo e($portfolio->title); ?>"
                                    ...
                                    <!-- Category Badge -->
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($portfolio->category === 'web'): ?>
                                    ...
                                    <?php elseif($portfolio->category === 'mobile'): ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($portfolio->festive_discount_enabled && $portfolio->festive_discount_percentage > 0): ?>
                                        <span class="badge" style="background: linear-gradient(135deg, #ff6b6b 0%, #ee5a52 100%); position: absolute; top: 50%; right: 12px; transform: translateY(-50%); padding: 12px 8px; font-size: 0.7rem; border-radius: 6px; color: white; text-align: center; min-width: 50px; box-shadow: 0 4px 12px rgba(255, 107, 107, 0.3);">
                                            <div style="font-weight: 700; font-size: 1.2rem;"><?php echo e((int)$portfolio->festive_discount_percentage); ?>%</div>
                                ...
                                <div class="card-body d-flex flex-column" style="padding: 20px;">
                                    <h5 class="card-title" style="font-weight: 700; margin-bottom: 10px; color: #333;">
                                        <a href="<?php echo e(route('shop.show', $portfolio)); ?>" class="text-decoration-none text-dark">
                                        ...
                                        <div>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($portfolio->festive_discount_enabled && $portfolio->festive_discount_percentage > 0): ?>
                                                <div style="font-size: 0.85rem; text-decoration: line-through; color: #999; margin-bottom: 4px;">
                                                    ₦<?php echo e(number_format($portfolio->price, 0)); ?>

                                                </div>
                                                <span style="font-size: 1.3rem; font-weight: 700; color: #ff6b6b;">
                                                    ₦<?php echo e(number_format($portfolio->price - ($portfolio->price * $portfolio->festive_discount_percentage / 100), 0)); ?>

                                                </span>
                                            <?php else: ?>
                                                <span style="font-size: 1.3rem; font-weight: 700; color: #667eea;">₦<?php echo e(number_format($portfolio->price, 0)); ?></span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                        <div>
                                            <small class="text-muted d-block">
                                                <i class="fas fa-eye" style="color: #667eea;"></i> <?php echo e($portfolio->view_count); ?>
                                ...
                                <div class="card-footer" style="background: #f8f9fa; border-top: 1px solid #e9ecef; padding: 15px; border-radius: 0;">
                                    <a href="<?php echo e(route('shop.show', $portfolio)); ?>" class="btn btn-sm w-100" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border: none; border-radius: 6px; font-weight: 600; padding: 10px;">
            ...
            <?php else: ?>
                <div class="card text-center py-5">
                    <div class="card-body">
                        ...
                        <a href="<?php echo e(route('shop.index')); ?>" class="btn btn-primary btn-sm">Clear Filters</a>
                    </div>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
...
function filterCategory(category) {
    try {
        ...
        window.location.href = '<?php echo e(route("shop.index")); ?>' + (params.toString() ? '?' + params.toString() : '');
    } catch(error) {
...
<?php echo $__env->make('layouts.buzbox', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Skyefaceofficial\resources\views/shop/index.blade.php ENDPATH**/ ?>