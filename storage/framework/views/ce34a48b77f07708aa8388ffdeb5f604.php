...
<html lang="en">
	...
	<head>
		...
		<meta name="description" content="Our Services — <?php echo e(config('company.name')); ?>">
		<meta name="author" content="<?php echo e(config('company.name')); ?>">

		<title><?php echo e(config('company.name')); ?> — Services</title>
	...
	<body id="page-top">
							...
							<div class="col-md-6" style="position: relative;">
								<div class="timeline-content wow fadeInLeft" data-wow-delay="0.1s" style="padding: 30px; background: rgba(255,255,255,0.95); border-radius: 8px; box-shadow: 0 8px 25px rgba(0,0,0,0.15); text-align: right;">
									<div style="display: flex; align-items: center; justify-content: flex-end; margin-bottom: 15px;">
										<a href="#" style="color: #333; text-decoration: none; margin-right: 15px;"><b style="font-size: 15px;"><?php echo e(config('company.name')); ?></b></a>
							...
							<div class="col-md-6" style="position: relative;">
								<div class="timeline-content wow fadeInRight" data-wow-delay="0.2s" style="padding: 30px; background: rgba(255,255,255,0.95); border-radius: 8px; box-shadow: 0 8px 25px rgba(0,0,0,0.15); text-align: left;">
									<div style="display: flex; align-items: center; margin-bottom: 15px;">
										...
										<a href="#" style="color: #333; text-decoration: none;"><b style="font-size: 15px;"><?php echo e(config('company.name')); ?></b></a>
									</div>
		...
		<section id="why-choose-us" class="financial-p5 bg-white">
			<div class="container">
				<div class="row title-bar">
					<div class="col-md-12">
						<h1 class="wow fadeInUp">Why Choose <?php echo e(config('company.name')); ?></h1>
						<div class="heading-border"></div>
					</div>
				</div>
				<div class="row">
		...
		<!-- Global Javascripts -->
		<script src="<?php echo e(asset('buzbox/js/jquery-3.3.1.min.js')); ?>"></script>
		<script src="<?php echo e(asset('buzbox/js/bootstrap/popper.min.js')); ?>"></script>
		<script src="<?php echo e(asset('buzbox/js/bootstrap/bootstrap.min.js')); ?>"></script>
		<script src="<?php echo e(asset('buzbox/js/smoothscroll.js')); ?>"></script>
		<script src="<?php echo e(asset('buzbox/js/jquery.easing.min.js')); ?>"></script>
		<script src="<?php echo e(asset('buzbox/js/wow.min.js')); ?>"></script>
		<script src="<?php echo e(asset('buzbox/js/owl.carousel.min.js')); ?>"></script>
		<script src="<?php echo e(asset('buzbox/js/custom.js')); ?>"></script>
			...
			async function submitQuoteForm(event) {
				...
				try {
					...
					const response = await fetch('<?php echo e(route("quotes.store")); ?>', {
						method: 'POST',
						headers: {
							'Content-Type': 'application/json',
...
<?php /**PATH C:\laragon\www\Skyefaceofficial\resources\views/services.blade.php ENDPATH**/ ?>