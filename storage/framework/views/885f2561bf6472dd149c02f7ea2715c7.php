<nav class="sidebar sidebar-offcanvas" id="sidebar">
  ...
  <ul class="nav">
    ...
    <li class="nav-item nav-profile">
      <a href="<?php echo e(route('admin.profile.show')); ?>" class="nav-link">
        ...
        <div class="text-wrapper">
          <p class="profile-name"><?php echo e(auth()->user()->fname ?? 'User'); ?> <?php echo e(auth()->user()->lname ?? ''); ?></p>
    ...
    <li class="nav-item">
      <a class="nav-link" href="<?php echo e(route('admin.contact-tickets.index')); ?>">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($openTickets > 0): ?>
          <span class="badge badge-danger"><?php echo e($openTickets); ?></span>
    ...
    <li class="nav-item">
      <a class="nav-link" href="<?php echo e(route('admin.orders.index')); ?>">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pendingOrders > 0): ?>
          <span class="badge badge-success"><?php echo e($pendingOrders); ?></span>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
      </a>
    </li>
    ...
    <li class="nav-item">
      <a class="nav-link" href="<?php echo e(route('admin.quotes.index')); ?>">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($newQuotes > 0): ?>
          <span class="badge badge-warning"><?php echo e($newQuotes); ?></span>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
      </a>
    </li>
    ...
    <li class="nav-item">
      <a class="nav-link" href="<?php echo e(route('admin.repairs.index')); ?>">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pendingRepairs > 0): ?>
          <span class="badge badge-warning"><?php echo e($pendingRepairs); ?></span>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
      </a>
    </li>
    ...
    <li class="nav-item">
      <a class="nav-link" href="<?php echo e(route('admin.payments.index')); ?>">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pendingPayments > 0): ?>
          <span class="badge badge-info"><?php echo e($pendingPayments); ?></span>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
      </a>
    </li>
    ...
    <li class="nav-item">
      <a class="nav-link" href="<?php echo e(route('admin.licenses.index')); ?>">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($expiringLicenses > 0): ?>
          <span class="badge badge-warning"><?php echo e($expiringLicenses); ?></span>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
      </a>
    </li>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('permission', ['view_page_impressions','view_impression_details','view_impression_statistics'])): ?>
    <li class="nav-item collapsible-item">
      ...
      <div class="collapse sub-collapse" id="page-impressions">
        <ul class="nav flex-column sub-menu">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('permission', 'view_page_impressions')): ?>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('admin.analytics.page-impressions.index')); ?>">
          ...
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('permission', 'view_impression_statistics')): ?>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('admin.analytics.page-impressions.stats')); ?>">
          ...
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('permission', 'view_device_analytics')): ?>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('admin.analytics.page-impressions.devices')); ?>">
          ...
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('permission', 'view_browser_analytics')): ?>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('admin.analytics.page-impressions.browsers')); ?>">
          ...
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('permission', 'view_os_analytics')): ?>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('admin.analytics.page-impressions.os')); ?>">
          ...
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('permission', 'view_visitor_analytics')): ?>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('admin.analytics.page-impressions.visitors')); ?>">
          ...
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('permission', 'export_impressions_data')): ?>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('admin.analytics.page-impressions.export')); ?>">
