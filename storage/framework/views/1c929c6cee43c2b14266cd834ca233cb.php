  ...
  <div class="col-md-3">
    <div class="card">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="<?php echo e(route('admin.settings.company_branding')); ?>" class="list-group-item list-group-item-action">
          <i class="fas fa-paint-brush mr-2"></i> Company Branding
        </a>
        <a href="<?php echo e(route('admin.settings.payment_processors')); ?>" class="list-group-item list-group-item-action">
    ...
    <div class="card mt-3">
      ...
      <div class="card-body small">
        ...
        <p class="mb-2">
          ...
          <span class="text-muted"><?php echo e(phpversion()); ?></span>
        </p>
        <p class="mb-2">
          <strong>Environment:</strong> <br>
          <span class="badge badge-<?php echo e(config('app.env') === 'production' ? 'danger' : 'warning'); ?>">
...
unset($__errorArgs, $__bag); ?>" id="company_name" name="company_name" value="<?php echo e($settings['company_name'] ?? config('company.name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="app_name" name="app_name" value="<?php echo e($settings['app_name'] ?? ''); ?>" required>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          ...
          <div class="form-group">
            ...
            <input type="url" class="form-control <?php $__errorArgs = ['app_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="app_url" name="app_url" value="<?php echo e($settings['app_url'] ?? ''); ?>" required>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['app_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          ...
          <div class="form-group">
            ...
            <select class="form-control <?php $__errorArgs = ['site_mode'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="site_mode" name="site_mode">
              <option value="live" <?php echo e(($settings['site_mode'] ?? 'live') === 'live' ? 'selected' : ''); ?>>Live</option>
              <option value="maintenance" <?php echo e(($settings['site_mode'] ?? '') === 'maintenance' ? 'selected' : ''); ?>>Maintenance</option>
              <option value="under_construction" <?php echo e(($settings['site_mode'] ?? '') === 'under_construction' ? 'selected' : ''); ?>>Under Construction</option>
            </select>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['site_mode'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control <?php $__errorArgs = ['site_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="site_title" name="site_title" value="<?php echo e($settings['site_title'] ?? ''); ?>">
            <small class="form-text text-muted">Short title shown on the maintenance/under construction pages.</small>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['site_title'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          ...
          <div class="form-group">
            ...
            <textarea class="form-control <?php $__errorArgs = ['site_message'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="site_message" name="site_message" rows="3"><?php echo e($settings['site_message'] ?? ''); ?></textarea>
            <small class="form-text text-muted">A brief message displayed to visitors when the site is not live.</small>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['site_message'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          ...
          <div class="form-group">
            ...
            <select class="form-control <?php $__errorArgs = ['app_timezone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="app_timezone" name="app_timezone" required>
              <option value="">-- Select Timezone --</option>
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $timezones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($tz); ?>" <?php echo e(($settings['app_timezone'] ?? '') === $tz ? 'selected' : ''); ?>><?php echo e($tz); ?></option>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          ...
          <div class="form-group">
            ...
            <select class="form-control <?php $__errorArgs = ['app_locale'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="app_locale" name="app_locale" required>
              <option value="en" <?php echo e(($settings['app_locale'] ?? '') === 'en' ? 'selected' : ''); ?>>English</option>
              <option value="es" <?php echo e(($settings['app_locale'] ?? '') === 'es' ? 'selected' : ''); ?>>Spanish</option>
              <option value="fr" <?php echo e(($settings['app_locale'] ?? '') === 'fr' ? 'selected' : ''); ?>>French</option>
              <option value="de" <?php echo e(($settings['app_locale'] ?? '') === 'de' ? 'selected' : ''); ?>>German</option>
              <option value="it" <?php echo e(($settings['app_locale'] ?? '') === 'it' ? 'selected' : ''); ?>>Italian</option>
              <option value="pt" <?php echo e(($settings['app_locale'] ?? '') === 'pt' ? 'selected' : ''); ?>>Portuguese</option>
            </select>
...
unset($__errorArgs, $__bag); ?>" id="support_email" name="support_email" value="<?php echo e($settings['support_email'] ?? ''); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="support_phone" name="support_phone" value="<?php echo e($settings['support_phone'] ?? ''); ?>" required>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['support_phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          ...
          <div class="form-group">
            ...
            <select class="form-control <?php $__errorArgs = ['mail_mailer'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="mail_mailer" name="mail_mailer" required>
              <option value="">-- Select Driver --</option>
              <option value="smtp" <?php echo e(($settings['mail_mailer'] ?? '') === 'smtp' ? 'selected' : ''); ?>>SMTP</option>
              <option value="mailgun" <?php echo e(($settings['mail_mailer'] ?? '') === 'mailgun' ? 'selected' : ''); ?>>Mailgun</option>
              <option value="postmark" <?php echo e(($settings['mail_mailer'] ?? '') === 'postmark' ? 'selected' : ''); ?>>Postmark</option>
              <option value="sendmail" <?php echo e(($settings['mail_mailer'] ?? '') === 'sendmail' ? 'selected' : ''); ?>>Sendmail</option>
              <option value="log" <?php echo e(($settings['mail_mailer'] ?? '') === 'log' ? 'selected' : ''); ?>>Log</option>
            </select>
...
unset($__errorArgs, $__bag); ?>" id="mail_host" name="mail_host" value="<?php echo e($settings['mail_host'] ?? ''); ?>">
...
unset($__errorArgs, $__bag); ?>" id="mail_port" name="mail_port" value="<?php echo e($settings['mail_port'] ?? ''); ?>">
...
unset($__errorArgs, $__bag); ?>" id="mail_username" name="mail_username" value="<?php echo e($settings['mail_username'] ?? ''); ?>">
...
unset($__errorArgs, $__bag); ?>" id="mail_password" name="mail_password" value="<?php echo e($settings['mail_password'] ?? ''); ?>">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          ...
          <div class="form-group">
            ...
            <select class="form-control <?php $__errorArgs = ['mail_encryption'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="mail_from_address" name="mail_from_address" value="<?php echo e($settings['mail_from_address'] ?? ''); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="mail_from_name" name="mail_from_name" value="<?php echo e($settings['mail_from_name'] ?? ''); ?>" required>
...
document.addEventListener('DOMContentLoaded', function () {
  try {
    ...
    var form = document.querySelector('form[action="<?php echo e(route('admin.settings.store')); ?>"]');
    if (form) {
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Skyefaceofficial\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>